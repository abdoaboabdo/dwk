            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary" style="overflow: hidden">
                        ...
                        <form role="form" action="{{route('dashboard.windows.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            {{method_field('post')}}
                            <div class="box-body">
...
@section('cropImage')
    ...
    <script type="text/javascript">
        $(document).ready(function() {// imgInp
            ...
            $('#category_id,#color,#thickness').change(function (e) {
                //console.log('sss');
                validation();
