            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary" style="overflow: hidden">
                        ...
                        <form role="form" action="{{route('dashboard.handrails.update',$handrail->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            {{method_field('put')}}
                            <div class="box-body">
                                        ...
                                        <div class="form-group has-success">
                                            ...
                                            <select name="category_id" id="category_id" class="form-control form-control " style="padding: 0 12px">
                                                ...
                                                @foreach($doorCategory->children as $child)
                                                    <option value="{{$child->id}}" {{$handrail->category_id === $child->id ? 'selected' : ''}}>{{$child->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group has-success">
                                            ...
                                            <input type="text" name="price" id="price" value="{{$handrail->price}}" class="form-control " placeholder="ادخل السعر">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4 ">
                                        <div class="form-group has-success">
                                            ...
                                            <textarea name="description" id="description" class="form-control "  cols="30" rows="10" placeholder="ادخل الوصف">{{$handrail->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row ">
                                    ...
                                    @foreach ($handrail->images as $key=>$image)
